...
const FLORALS = [
  ...
  { emoji: '🌻', left: '91%', top: '58%', size: '2.4rem', dur: 5.5, delay: 0.3  },
  { emoji: '🪷', left: '44%', top: '4%',  size: '2rem',   dur: 4.2, delay: 2.0  },
  { emoji: '🌹', left: '2%',  top: '38%', size: '1.8rem', dur: 5.0, delay: 1.0  },
  { emoji: '🌸', left: '76%', top: '74%', size: '2.5rem', dur: 4.8, delay: 0.5  },
  { emoji: '🌺', left: '54%', top: '88%', size: '1.6rem', dur: 4.1, delay: 1.8  },
  { emoji: '🌼', left: '29%', top: '83%', size: '2.2rem', dur: 5.3, delay: 0.2  },
  { emoji: '🪷', left: '70%', top: '28%', size: '1.9rem', dur: 4.6, delay: 1.2  },
  { emoji: '🌸', left: '19%', top: '28%', size: '1.5rem', dur: 3.8, delay: 2.5  },
  { emoji: '🌻', left: '60%', top: '14%', size: '2rem',   dur: 5.0, delay: 0.7  },
  { emoji: '🌹', left: '38%', top: '72%', size: '1.7rem', dur: 4.4, delay: 3.0  },
  { emoji: '🪷', left: '82%', top: '42%', size: '2.1rem', dur: 4.9, delay: 1.6  },
]
...
const FAQS = [
  ...
  {
    q: 'What\'s included in the ₹699 price?',
    ...
    <div className="overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center py-28 overflow-hidden">
        ...
        <div className="absolute inset-0"
          style={{ background: 'linear-gradient(135deg, #FFF0F5 0%, #FBF7F0 40%, #FFFBEB 100%)' }}
        />
        ...
        {FLORALS.map((f, i) => (
          <motion.div
            ...
            style={{ left: f.left, top: f.top, fontSize: f.size, lineHeight: 1 }}
            animate={{ y: [0, -18, 0], rotate: [-6, 6, -6], opacity: [0.5, 0.9, 0.5] }}
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 w-full">
          ...
          >
            ...
            >
              ...
              <span
                style={{
                  background: 'linear-gradient(90deg, #EC4899, #C9A962, #8B5CF6)',
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-2xl mx-auto">
            ...
            >
              ...
              <div className="relative">
                ...
                <h2 className="text-white font-semibold text-xl mb-2">WhatsApp Us</h2>
                <p className="text-emerald-100/90 text-sm leading-relaxed mb-5">
                  Chat directly with our team. Available every day, 9 AM – 9 PM IST.
                </p>
            ...
            >
              ...
              <div className="relative">
                ...
                <h2 className="text-white font-semibold text-xl mb-2">Email Us</h2>
                <p className="text-violet-200/90 text-sm leading-relaxed mb-5">
                  Send a detailed message. We reply to every email within 24 hours.
                </p>
          ...
          >
            ...
            <strong className="text-[--color-charcoal]/65 font-semibold">under 2 hours</strong>
          </motion.p>
        </div>
      </section>
      ...
      <section className="relative py-24 bg-[--color-charcoal] overflow-hidden">
        ...
        <div className="absolute top-6 left-8 font-[--font-cormorant] text-[5rem] text-[--color-gold]/8 leading-none pointer-events-none select-none">❧</div>
        <div className="absolute bottom-6 right-8 font-[--font-cormorant] text-[5rem] text-[--color-gold]/8 leading-none rotate-180 pointer-events-none select-none">❧</div>
        ...
        <div className="relative max-w-xl mx-auto px-4 sm:px-6 text-center">
          ...
          >
            ...
            <Link
              ...
              style={{ background: 'linear-gradient(135deg, #D4B468, #C9A962)' }}
            >
      ...
      <section
        ...
        style={{ background: 'linear-gradient(180deg, #FBF7F0 0%, #FFF0F5 100%)' }}
      >
        {/* Background ornaments */}
        <div className="absolute top-10 right-12 font-[--font-cormorant] text-[7rem] text-[--color-gold]/5 leading-none pointer-events-none select-none">❧</div>
        <div className="absolute bottom-10 left-12 font-[--font-cormorant] text-[7rem] text-[--color-gold]/5 leading-none rotate-180 pointer-events-none select-none">❧</div>
